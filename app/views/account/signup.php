                ...
                <!-- <div class="form-group">
                    ...
                    <div>
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="form-check-1" name="gender" value="female"
                                checked>
                            <label for="form-check-1" class="form-check-lable">Nam</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="form-check-2" name="gender" value="male">
...
<!-- <div style="">
    <form method="get" onsubmit="return checkFormDangKy()">
        <div> <input type="text" id="txtHoten" name="txtHoTen" placeholder="Ho ten...">
        </div>
        <span>Error</span>
        <div> <input type="text" id="txtUserName" name="txtUserName" placeholder="Ten dang nhap...">
        </div>
        <div> <input type="password" id="txtPassword" name="txtPassword" placeholder="Mat khau...">
        </div>
        <div> <input type="text" id="txtDiaChi" placeholder="Dia chi...">
        </div>
        <div> <input type="text" id="txtEmail" placeholder="Email...">
        </div>
        <div> <input type="text" id="txtSdt" placeholder="Sdt...">
        </div>
        <input id="btn-signup" value="Dang Ky">
    </form>
</div> -->